...
/**
 * validateModel - Er en utility funksjon som validater om man bruker schema som er laget i schema.prisma.
 * Dette er en funksjon som man kan kalle i alle database operasjoner istedenfor å kjøre en if check i hver kodeblokk.
 *
 * @param {string} model - Data model som kommer fra prisma.schema
 */
